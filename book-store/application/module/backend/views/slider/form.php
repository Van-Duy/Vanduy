...
// create (Save-close)
$linkSave          = URL::createLink('backend', 'slider', 'form', array('type' => 'save'));
$save              = Html::cmsButtonSave('Save', 'btn-success', $linkSave, 'submit');

$linkSaveClose     = URL::createLink('backend', 'slider', 'form', array('type' => 'save-close'));
$saveClose         = Html::cmsButtonSave('Save &amp; Close', 'btn-success', $linkSaveClose, 'submit');

$linkSaveNew       = URL::createLink('backend', 'slider', 'form', array('type' => 'save-new'));
...
if (!empty($result['id'])) {
    ...
    $img            = Html::createImage($result['picture'],$result['picture'],'slider','',['max-width' => 200,'max-hight' => 200]);
        ...
        <div class="card card-info card-outline">
            <div class="card-body">
                <form action="#" method="post" class="mb-0" id="form" name="form" enctype="multipart/form-data">
                    <?php echo $nameDiv . $imgDiv . $pictureDiv  . $statusDiv . $idDiv . $inputPictureHidden; ?>
