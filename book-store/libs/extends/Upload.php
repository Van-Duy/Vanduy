...
class Upload{
	...
	static function uploadFile($fileObj, $folderUpload, $width = 60, $height = 90,$options = null){
		if($options == null){
			if($fileObj['tmp_name'] != null){
				$uploadDir		= UPLOAD_PATH . $folderUpload . DS;
				$fileName		= self::randomString(8) . '.' . pathinfo($fileObj['name'], PATHINFO_EXTENSION);
	...
	static function removeFile($folderUpload, $fileName){
